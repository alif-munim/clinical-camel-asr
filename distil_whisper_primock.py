...
import csv
import time
import librosa  # Added for audio length calculation
...
def main():
    ...
    parser.add_argument("--model_type", choices=["distil-large-v3.5", "whisper-large-v3-turbo", "whisper-large-v3"], default="distil-large-v3.5", 
                        help="Model type to use (distil-large-v3.5, whisper-large-v3-turbo, or whisper-large-v3)")
    ...
    parser.add_argument("--chunk_length", type=int, default=0, help="Length of chunks in seconds for processing long audio (0 for no chunking)")
    parser.add_argument("--batch_size", type=int, default=1, help="Batch size for processing chunks")
