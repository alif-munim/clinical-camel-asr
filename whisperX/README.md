...
python run_whisperx_local.py --input ./wav_audio/84-TreatmentVisit-continuecurrenttreatment-RadiationOnc-Script-Claude.wav --output corrected --num_speakers 3

python run_whisperx_local.py --input ./wav_audio/80-NewPatient-SurgicalOnc-Script-Claude.wav --output corrected --num_speakers 4

python run_whisperx_local.py --input ./wav_audio/52-TreatmentVisit-changetreatment-toxicity-SurgicalOnc-ScriptClaude.wav --output corrected --num_speakers 3
